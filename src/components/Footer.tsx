  ...
  return (
    ...
    >
        ...
        >
          <Box aria-label="office address">
            ...
            <FooterChild
              label="address maps"
              icon={<PlaceIcon />}
              href={footerInformation.office.href}
              value={footerInformation.office.value}
            />
          </Box>
          <Box aria-label="contact">
            ...
            <FooterChild
              label="phone number"
              icon={<PhoneIcon />}
              href={footerInformation.phone.href}
              value={footerInformation.phone.value}
            />
            <FooterChild
              label="email address"
              icon={<EmailIcon />}
              href={footerInformation.email.href}
              value={footerInformation.email.value}
            />
            <Typography
      ...
      <Typography
        variant="h5"
        component="p"
        my={isDesktopRatio ? "75px" : "32px"}
        ml="auto"
      >
        Copyrights &#169; 2024 Pusakawan{" "}
      </Typography>
    </Box>
  );
}
